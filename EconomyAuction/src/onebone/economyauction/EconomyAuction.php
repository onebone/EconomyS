	...
	public function quitAuction($auction) {
		...
		if($this->auctions[$auction][4] !== null) {
			...
			if($p instanceof Player) {
				...
				EconomyAPI::getInstance()->reduceMoney($p, $this->auctions[$auction][5], null,"EconomyAuction", true);
			...
			EconomyAPI::getInstance()->addMoney($auction, $this->auctions[$auction][5], null, "EconomyAuction", true);
		}else{
