...
## FAQ
Q> Why did you try support API 4.0 with some crazy hacks?
...
Q> Then why did you drop support for the stable API and only support API 4.0?
A> I have asked @nnnlog to create a branch for API 3.x. Sorry! Was fully my mistake to drop support for stable version.

Q> Are you going to maintain after Nov 14?
